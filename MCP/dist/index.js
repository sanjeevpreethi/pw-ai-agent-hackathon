...
class BrowserAutomationServer {
    ...
    getServer() {
        ...
        // browserinitialize
        server.registerTool('browserinitialize', {
        ...
        // browserclick
        server.registerTool('browserclick', {
        ...
        // browsertype
        server.registerTool('browsertype', {
        ...
        // browsernavigate
        server.registerTool('browsernavigate', {
        ...
        // browserwaitfor
        server.registerTool('browserwaitfor', {
        ...
        // browsersnapshot
        server.registerTool('browsersnapshot', {
        ...
        server.registerTool('browsertakescreenshot', {
        ...
        server.registerTool('browserconsolemessages', {
        ...
        server.registerTool('browsernetworkrequests', {
        ...
        // browserselectoption
        server.registerTool('browserselectoption', {
        ...
        // browserhover
        server.registerTool('browserhover', {
        ...
        // browserdrag
        server.registerTool('browserdrag', {
        ...
        // browserfileupload
        server.registerTool('browserfileupload', {
        ...
        // browserhandledialog
        server.registerTool('browserhandledialog', {
        ...
        // browserpresskey
        server.registerTool('browserpresskey', {
        ...
        // browserevaluate
        server.registerTool('browserevaluate', {
        ...
        // browserruncode
        server.registerTool('browserruncode', {
        ...
        server.registerTool('browsergetaccessibilitytree', {
            ...
            const elements = await this.page.evaluate(() => {
                const interactive = Array.from(document.querySelectorAll('input, button, select, textarea, a[href], [role="button"], [role="textbox"], [role="combobox"], [role="link"]'));
        ...
        // browserclose
        server.registerTool('browserclose', {
        ...
        // plannersetuppage
        server.registerTool('plannersetuppage', {
        ...
        // plannersaveplan
        server.registerTool('plannersaveplan', {
